...
const SignupPage = () => {
  ...
  return (
    <div className="min-h-[80dvh] flex items-center justify-center bg-primary">
      <section className="bg-primary flex items-center w-full">
        <div className="flex flex-col w-full max-w-xl items-center justify-center mx-auto rounded-xl">
          <div className="w-full rounded-xl shadow md:mt-0 sm:max-w-md xl:p-0">
            <div className="space-y-4 md:space-y-3 sm:p-8 bg-[#041714] p-6 rounded-xl">
