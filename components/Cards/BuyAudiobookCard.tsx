    ...
    <div className="flex p-6 rounded-lg items-start space-x-6 bg-[#0d1f22] text-white">
      ...
      <div className="flex flex-col items-start gap-4 justify-between w-1/4">
        ...
        <div className="flex flex-col space-y-3">
          <button className="flex items-center justify-center px-6 py-2 bg-green-600 text-white font-semibold rounded-full hover:bg-green-700 transition-all duration-300 focus:outline-none">
            <IconPlayerPlayFilled size={16} className="mr-2" />
            Listen Now
          </button>
          <button className="flex items-center justify-center px-4 py-2 text-white font-semibold rounded-full border border-white hover:bg-white hover:text-black transition-all duration-300 focus:outline-none">
...
export default BuyAudiobookCard;
